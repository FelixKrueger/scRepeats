...
sub align_fragments_to_the_human_repeatome {
  ...
  my @fhs = (
      { name => 'HERVL',
	      repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/new_LTR_repeatome/HERVL/HERVL',
      },
      { name => 'LTR12',
	      repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/new_LTR_repeatome/LTR12/LTR12',
      },
      { name => 'LTR7B',
      	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/new_LTR_repeatome/LTR7B/LTR7B',
      },
      { name => 'MLT2A1',
      	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/new_LTR_repeatome/MLT2A1/MLT2A1',
      },
      { name => 'MLT2A2',
	      repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/new_LTR_repeatome/MLT2A2/MLT2A2',
      },
    );
  


  # Now starting 5 instances of Bowtie2 feeding in the sequence file, one for every type of repeat and reading in the sequence identifier for the first
